...
the one with 0305 in name (Flight controller loader) : there is no 0305 module for this P4P fw version
the one with 0306 in name (Flight controller)
the .cfg.sig file (wm100a / wm220 / wm331)
...
the result file should have the followinf md5 hash :
3acb256304aaf5239814207da7d94cad  wm100a.cfg.ori
f0b9aff5199745ff0eab4d189d9f562a  wm220.cfg.ori
4a8dc7297c4bb093568ea79df7ec5073  wm331.cfg.ori
...
aaeb606a4a86fb1fc9a0f6bc6314d3a4  wm100_0306_v03.02.43.20_20170920.pro.fw_0306.decrypted.bin
03ca7a87993ae824dac37345e187fab8  wm220_0306_v03.02.44.07_20171116.pro.fw_0306.decrypted.bin
1ce9b3049390b77d7941cabcc312106e  wm331_0306_v03.02.44.07_20171116.pro.fw_0306.decrypted.bin
...
mount -o bind /vendor/bin/dummy_verify.sh /sbin/dji_verify for Spark ad Mavic
or
...
A short read to dummy_verify scrpt should let you understand how it works (and why it's called that way) : Just calling the dji_verify "copy"
...
The downloaded files are stored under /data/data/dji.pilot.pad/app_com.dji.go.android.agps. The onlien fiel is about 7800 bytes and the offline one around 38000 bytes
